...
// @ts-ignore
export function useFindNotificationsUnreadCountSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<FindNotificationsUnreadCountQuery, FindNotificationsUnreadCountQueryVariables>): Apollo.UseSuspenseQueryResult<FindNotificationsUnreadCountQuery, FindNotificationsUnreadCountQueryVariables>;
export function useFindNotificationsUnreadCountSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<FindNotificationsUnreadCountQuery, FindNotificationsUnreadCountQueryVariables>): Apollo.UseSuspenseQueryResult<FindNotificationsUnreadCountQuery | undefined, FindNotificationsUnreadCountQueryVariables>;
